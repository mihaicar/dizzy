...
\\ \\
I would also like to thank my friends Dom, Ab, Elias, David and Giacomo for teaching me that the dissertation is not the only important part of a final year student's life, and my mother and the rest of my family for their encouragement during my \textit{Imperial years}.
\newpage
\end{comment}
\tableofcontents
\newpage
...
\lstinputlisting[label = {l:genissue}, language=Octave, caption = Generating a share contract]{/Users/mikecar/Desktop/Blockchain-dizzy/imgs/genIssue.m}
...
\lstinputlisting[label = {l:genmove}, language=Octave, caption = Moving a share contract to a different owner]{/Users/mikecar/Desktop/Blockchain-dizzy/imgs/genMove.m}
...
\lstinputlisting[label = {l:notary}, language=Octave, caption = NotaryFlow code verifying transaction details]{/Users/mikecar/Desktop/Blockchain-dizzy/imgs/notary.m}
...
\lstinputlisting[label = {l:finality}, language=Octave, caption = FinalityFlow code notarising\, recording and broadcasting a transaction]{/Users/mikecar/Desktop/Blockchain-dizzy/imgs/finality.m}
...
\lstinputlisting[label = {l:cashissuance}, language=Octave, caption = Example of calling the issuer flow which populates a node's vault with cash states]{/Users/mikecar/Desktop/Blockchain-dizzy/imgs/cashissuance.m}
...
\lstinputlisting[label = {l:regs}, language=Octave, caption = Broadcasting transaction to regulator nodes]{/Users/mikecar/Desktop/Blockchain-dizzy/imgs/regs.m}
...
\begin{comment} %use this to compare initial plans with successes!! self-evaluation
\section{Timeline}
...
\\ \\
To put everything into context and prove the system is usable, the demo CorDapp will use the interface provided by Corda already and enrich it with other required features. This means that there will be a suite of contacts and commercial papers written to satisfy the needs of a customer (although in a basic format, at least initially). 
\\ \\
...
%%\newpage
%%\subsection*{\textit{Random trading} application snippets}
